...
VERSION = "noto-joint-sensitivity-separated-capability-marginal-v2"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Sensitivity output directory; defaults to joint_sensitivity_separated_capability_marginal_v2 below the base output directory.",
    )
...
def main() -> None:
    ...
    output_dir = Path(args.output_dir).resolve() if args.output_dir else base_output_dir / "joint_sensitivity_separated_capability_marginal_v2"
