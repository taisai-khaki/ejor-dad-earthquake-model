...
Copy-ReleaseTree -RelativeSource 'correlated_facility_separated_capability_marginal_v2\configs' -RelativeDestination 'correlated_facility\configs' -Extensions @('.json')
